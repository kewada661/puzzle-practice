export const algs = [
  {
    ...
    name: "Z",
    alg: ["M' U M2 U M2 U M' U2 M2", "y M' U' M2 U' M2 U' M' U2 M2", "y M2 U M2 U M' U2 M2 U2 M'", "M2 U' M2 U' M' U2 M2 U2 M'"],
    group: "Edges Only",
    prob: 2,
  }, {
    name: "Ua",
    alg: ["M2 U M U2 M' U M2", "R U' R U R U R U' R' U' R2", "y2 R2 U' R' U' R U R U R U' R"],
    group: "Edges Only",
    prob: 4,
  }, {
    name: "Ub",
    alg: ["M2 U' M U2 M' U' M2", "R2 U (R U R' U') R' U' R' U R'", "y2 R' U R' U' R' U' (R' U R U) R2", "y2 R' U R' U' R3 U' (R' U R U) R2"],
    group: "Edges Only",
    prob: 4,
  }, {
    name: "Aa",
    alg: ["x L2 D2 L' U' L D2 L' U L'", "y' x' L' U L' D2 L U' L' D2 L2", "y x R' U R' D2 R U' R' D2 R2", "y2 x' R2 D2 R' U' R D2 R' U R'"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Ab",
    alg: ["x' L2 D2 L U L' D2 L U' L", "y x L U' L D2 L' U L D2 L2", "y2 x R2 D2 R U R' D2 R U' R", "y' x' R U' R D2 R' U R D2 R2"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "E",
    alg: ["x' L' U L D' L' U' L D L' U' L D' L' U L D", "x' R U' R' D R U R' D' R U R' D R U' R' D'"],
    ...
    name: "Ja",
    alg: ["x R2 F R F' R U2 r' U r U2", "y2 L' U' L F L' U' L U L F' L2 U L", "y' R' U L' U2 R U' R' U2 R L"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Jb",
    ...
    name: "Ra",
    alg: ["R U' R' U' R U R D R' U' R D' R' U2 R'", "R U R' F' R U2 R' U2 R' F R U R U2 R'", "y' L U2 L' U2 L F' L' U' L U L F L2"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Rb",
    alg: ["R2 F R U R U' R' F' R U2 R' U2 R", "y' R' U2 R U2 R' F R U R' U' R' F' R2", "R' U2 R' D' R U' R' D R U R U' R' U' R"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "T",
    ...
    name: "Y",
    alg: ["F R U' R' U' R U R' F' R U R' U' R' F R F'", "F R' F R2 U' R' U' R U R' F' R U R' U' F'"],
    group: "Diagonal Corner Swap",
    prob: 4,
  }, {
    name: "V",
    alg: ["R' U R' U' y R' F' R2 U' R' U R' F R F", "R' U R' U' R D' R' D R' U D' R2 U' R2 D R2", "z D' R2 D R2 U R' D' R U' R U R' D R U' z'", "R U2 R' D R U' R U' R U R2 D R' U' R D2", "x' R' F R F' U R U2 R' U' R U' R' U2 R U R' U'"],
    group: "Diagonal Corner Swap",
    prob: 4,
  }, {
    name: "Na",
    alg: ["R U R' U R U R' F' R U R' U' R' F R2 U' R' U2 R U' R'", "z U R' D R2 U' R D' U R' D R2 U' R D'"],
    group: "Diagonal Corner Swap",
    prob: 1,
  }, {
    name: "Nb",
    alg: ["R' (U R U' R') F' U' F R U R' F R' F' R U' R", "z D' R U' R2 D R' U D' R U' R2 D R' U"],
    group: "Diagonal Corner Swap",
    prob: 1,
  }, {
    name: "Ga",
    alg: ["R2 U R' U R' U' R U' R2 (U' D) R' U R D'", "R2 u R' U R' U' R u' R2 y' R' U R"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Gb",
    alg: ["R' U' R (U D') R2 U R' U R U' R U' R2 D", "y F' U' F R2 u R' U R U' R u' R2"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Gc",
    alg: ["R2 U' R U' R U R' U R2 (U D') R U' R' D", "y2 R2 F2 R U2 R U2 R' F R U R' U' R' F R2", "R2 u' R U' R U R' u R2 y R U' R'"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }, {
    name: "Gd",
    alg: ["R U R' (U' D) R2 U' R U' R' U R' U R2 D'", "R U R' y' R2 u' R U' R' U R' u R2"],
    group: "Adjacent Corner Swap",
    prob: 4,
  }
]